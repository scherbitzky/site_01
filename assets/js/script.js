...
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    document.querySelector('.form-subscribe__input').readOnly = true;
    document.querySelector('.form-subscribe__button').readOnly = true;
  })
}
...
if (joinBtn) {
  joinBtn.addEventListener('click', function (e) {
    ...
    joinForm.addEventListener('submit', function (e) {
      ...
      document.querySelectorAll('.message-form__input').forEach(function (el) {
        el.readOnly = true;
      });
      document.querySelector('.message-form__textarea').readOnly = true;
      document.querySelector('.message-form__button').readOnly = true;
    });
  });
}